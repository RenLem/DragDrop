package omy.boston.dragdrop.views;
...
import omy.boston.dragdrop.MainActivity;
...
public class DotDragDrop extends View {
    ...
    public DotDragDrop(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mPaint = new Paint();
